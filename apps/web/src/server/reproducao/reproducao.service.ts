...
const CATEGORIAS_REPRODUTIVAS: CategoriaAnimal[] = [CategoriaAnimal.MATRIZ, CategoriaAnimal.VACA, CategoriaAnimal.TOURO];
...
export async function listarMatrizes(empresaId: string) {
